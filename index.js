...
console.log(createMenuItem('pizza', 5, 'snacks'));
console.log(createMenuItem('salad', 8, 'side'));
...
reviews.push({name:'TJ', rating:6.5, feedback:'Very average food and service'});
console.log(reviews);
...
function getLastReview(reviews,index) {
    return `${reviews[index].name} gave the restaraunt a ${reviews[index].rating} and their feedback was: ${reviews[index].feedback}`;
  } 
